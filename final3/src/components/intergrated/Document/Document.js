...
useEffect(() => {
        const fetchProjectInfo = async () => {
            ...
            setProjectName(response.data.projectName); };// 가져온 프로젝트 정보 중에서 프로젝트 이름 설정
            fetchProjectInfo();
        }, [projectNo]);
                            ...
                            <div className="card-body">
                                <div className="card-body d-flex flex-wrap justify-content-between">
                                    <div className="card-text">
                                        ...
                                        <div className="rounded border p-2 shadow-sm bg-light" style={{ width: "250px", marginRight: "10px" }}>프로젝트 이름: {document.projectName}</div>
